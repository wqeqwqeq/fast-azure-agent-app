...
Note: This is a copy of the opsagent middleware to keep agent_factory independent.
The middleware uses get_settings().orchestration_agents to determine which agents
should output their structured response in the thinking flyout.
"""
